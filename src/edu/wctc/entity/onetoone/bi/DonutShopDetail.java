...
public class DonutShopDetail {
    ...
    // Added for bidirectional mapping. Allows a DonutShopDetail know which DonutShop it belongs to.
    // mappedBy contains the name of the DonutShopDetail field in the DonutShop class
    // CascadeType.ALL means that creating, updating, or deleting a DonutShopDetail will do same to its DonutShop object
    //@OneToOne(mappedBy = "detail", cascade = CascadeType.ALL)
    // Cascades everything but delete
